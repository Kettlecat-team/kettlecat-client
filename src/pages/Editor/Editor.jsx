...
let defaults = {
  ...
  const UPDATE_CHAKIBOO = gql`
        mutation updateChakiboo($title: String, $code: String, $description: String, $tags: [String], $language: String, $id: String) {
            updateChakiboo(id: $id, input: {
            title: $title,
            code: $code,
    ...
    render() {
        return (
            ...
            // return(
                ...
                addChakiboo({ variables: {id: this.props.match.params.id, title: this.state.title, description: this.state.description, code: this.state.code, tags: this.state.tags, language: this.state.mode } })}}
